...
// console.log('COUNTER FOR ITERATIVE BINARY');
//logarithmic O(log(n))
// console.log(convertToBinaryIter(124)); //1111100

// console.log(convertToBinaryIter(5));
// console.log(counter);
// counter = 0;
// console.log(convertToBinaryIter(10));
// console.log(counter);
// counter = 0;
// console.log(convertToBinaryIter(15));
// console.log(counter);
// counter = 0;
// console.log(convertToBinaryIter(250));
// console.log(counter);
// counter = 0;
// console.log(convertToBinaryIter(2500));
// console.log(counter);
...
// console.log('COUNTER FOR ITERATIVE FIB');
// for(let i = 1; i<445; i++){
